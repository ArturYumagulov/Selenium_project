...
class TestAbs(unittest.TestCase):
    ...
    def test_reg2(self):
        x = Registration()
        self.assertEqual(x.start("http://suninjuly.github.io/registration1.html"), None, "Should be absolute value od number")
    ...
    def test_reg1(self):
        x = Registration()
        self.assertEqual(x.start("http://suninjuly.github.io/registration2.html"), None, "Should be absolute value od number")
